...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: '안녕하세요. 동호회 안내 도우미입니다. 무엇을 도와드릴까요?',
    },
  ]);
    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-primary-500 text-white rounded-full shadow-lg hover:bg-primary-600 flex items-center justify-center z-50"
        >
        ...
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-white rounded-lg shadow-2xl flex flex-col z-50">
          ...
          <div className="bg-primary-500 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">동호회 안내</span>
            </div>
              ...
              >
                <div
                  className={`max-w-[80%] p-3 rounded-lg ${
                    msg.role === 'user' ? 'bg-primary-500 text-white' : 'bg-gray-200 text-gray-800'
                  }`}
                >
